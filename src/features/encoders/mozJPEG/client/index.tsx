          ...
          {showAdvanced ? (
            <div>
              <label class={style.optionTextFirst}>
                ...
                >
                  <option value={MozJpegColorSpace.GRAYSCALE}>Grayscale(灰度)</option>
                  <option value={MozJpegColorSpace.RGB}>RGB(红绿蓝颜色空间)</option>
                  <option value={MozJpegColorSpace.YCbCr}>YCbCr(亮度-色度分离颜色空间)</option>
                </Select>
              </label>
              <Expander>
